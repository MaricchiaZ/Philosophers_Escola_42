...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/13 10:45:47 by maclara-          #+#    #+#             */
/*   Updated: 2023/04/24 06:14:44 by maclara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo_bonus.h"

void	ft_putstr_fd(char *s, int fd) //Produz a string 's' para o descritor de arquivo dado.
{
	...
	{
		write (fd, &s[i], 1); // no descritor de arquivo fd colocamos o  conteúdo de s[i]
